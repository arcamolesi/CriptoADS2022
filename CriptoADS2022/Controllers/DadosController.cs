...
namespace CriptoADS2022.Controllers
{
    public class DadosController : Controller
    {
        ...
        public IActionResult Moeda()
        {
            ...
            do
            {
                while (reader.Read())
                {
                    ...
                    moeda.descricao = reader[1].ToString();
                    moeda.sigla = reader[2].ToString();
                    moeda.compra = Convert.ToSingle(reader[3].ToString());
                    moeda.venda = moeda.compra + moeda.compra * randNum.Next(1, 50) / 100;
                    try
                    {
                        moeda.capital = Convert.ToSingle(reader[4].ToString());
                    }
                    catch
                    {
                        moeda.capital = 0;
                    ...
                    try
                    {
                        moeda.vol24 = Convert.ToSingle(reader[5].ToString());
                    }
                    catch
                    {
                        moeda.vol24 = 0;
                    ...
                    try
                    {
                        moeda.voltotal = Convert.ToSingle(reader[6].ToString());
                    }
                    catch
                    {
                        moeda.voltotal = 0;
                    ...
                    try
                    {
                        moeda.var24h = Convert.ToSingle(reader[7].ToString());
                    }
                    catch
                    {
                        moeda.var24h = 0;
                    ...
                    try
                    {
                        moeda.var7d = Convert.ToSingle(reader[8].ToString());
                    }
                    catch
                    {
                        moeda.var7d = 0;
        ...
        {
            contexto.Database.ExecuteSqlRaw("delete from conta");
            contexto.Database.ExecuteSqlRaw("DBCC CHECKIDENT('conta', RESEED, 0)");
            Random randNum = new Random();
        ...
        public IActionResult Transacao()
        {
            ...
            for (int i = 0; i < 10000; i++)
            {
                ...
                transacao.data = Convert.ToDateTime("02/01/2021").AddDays(randNum.Next(0, 650)); 
